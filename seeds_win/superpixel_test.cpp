...
int main(int argc, char* argv[])
{
  ...
  UINT pValue;
  //UINT pdValue; //ansh modified
  char c;
  UINT r,g,b; //dx,dy;  //ansh modified
  UINT d = 0;
  int idx = 0;
  ...
  //boost::format itr_format; //ansh modified
  //itr_format.parse("%02i");
  ...
  *******************************************/
  ...
  SEEDS seeds(width, height, 3, NR_BINS, 0);
  ...
  seeds.iterate();
  cout<<"Compute finished, time: "<< (getTickCount() - t) / getTickFrequency() << "sec" <<endl;
  ...
  DrawContoursAroundSegments(ubuff, seeds.labels[nr_levels-1], width, height, 0xffffff, false);//0xffffff draws white contours
